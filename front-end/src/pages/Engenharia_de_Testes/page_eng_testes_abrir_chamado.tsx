...
export function AbrirChamado() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Locais
                const responseLocais = await fetch('http://10.161.100.176:5000/api/locais');
                ...
                // Tipos de chamados
                const responseTipos = await fetch('http://10.161.100.176:5000/api/tiposChamados');
                if (responseTipos.ok) {
                ...
                // Clientes
                const responseClientes = await fetch('http://10.161.100.176:5000/api/clientes');
                ...
                // Produtos
                const responseProdutos = await fetch('http://10.161.100.176:5000/api/produtos');
                ...
                const responsePlano = await fetch('http://10.161.100.176:5000/api/planododia');
                if (responsePlano.ok) {
                    ...
                    if (planoProducao !== null) {
                        ...
                        const responseProdutos = await fetch(`http://10.161.100.176:5000/api/produtosnoplano?planoProducao=${encodeURIComponent(planoProducao.pdp_id)}`, {
                            method: 'GET',
                            headers: {
    ...
    const abrirChamado = async (event: React.FormEvent) => {
        ...
        try {
            const responseAbrirChamado = await fetch('http://10.161.100.176:5000/api/abrirchamado', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
