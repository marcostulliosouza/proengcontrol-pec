...
export function AbrirChamado() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Locais
                const responseLocais = await fetch('http://172.21.96.1:5173/api/locais');
                ...
                // Tipos de chamados
                const responseTipos = await fetch('http://172.21.96.1:5173/api/tiposChamados');
                if (responseTipos.ok) {
                ...
                // Clientes
                const responseClientes = await fetch('http://172.21.96.1:5173/api/clientes');
                ...
                // Produtos
                const responseProdutos = await fetch('http://172.21.96.1:5173/api/produtos');
    ...
    const abrirChamado = async (event: React.FormEvent) => {
        ...
        try {
            const responseAbrirChamado = await fetch('http://172.21.96.1:5173/api/abrirchamado', {
                method: 'POST',
                headers: {
