...
export function AbrirChamado() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Locais
                const responseLocais = await fetch('http://backend:5000/api/locais');
                ...
                // Tipos de chamados
                const responseTipos = await fetch('http://backend:5000/api/tiposChamados');
                if (responseTipos.ok) {
                ...
                // Clientes
                const responseClientes = await fetch('http://backend:5000/api/clientes');
                ...
                // Produtos
                const responseProdutos = await fetch('http://backend:5000/api/produtos');
    ...
    const abrirChamado = async (event: React.FormEvent) => {
        ...
        try {
            const responseAbrirChamado = await fetch('http://backend:5000/api/abrirchamado', {
                method: 'POST',
                headers: {
