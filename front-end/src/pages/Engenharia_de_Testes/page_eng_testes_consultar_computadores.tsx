...
export function ConsultarComputadores() {
    ...
    useEffect(() => {
        const fetchComputadores = async () => {
            try {
                // Computadores
                const responseComputadores = await fetch('http://172.17.12.33:5000/api/computadores');
                if (responseComputadores.ok) {
                    ...
                    const responseVinculoProdutos = await fetch('http://172.17.12.33:5000/api/vinculoComputadores');
