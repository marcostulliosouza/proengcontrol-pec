...
export function ConsultarDispositivos() {
    ...
    useEffect(() => {
        const fetchDispositivos = async () => {
            try {
                // Dispositivos
                const responseDispositivos = await fetch('http://10.161.100.176:5000/api/dispositivos');
                if (responseDispositivos.ok) {
                    ...
                    // Notas Fiscais
                    const responseEntradaSaidaEquipamento = await fetch('http://10.161.100.176:5000/api/entradaSaidaEquipamento');
                    const responseNotasFiscais = await fetch('http://10.161.100.176:5000/api/notasFiscais');
