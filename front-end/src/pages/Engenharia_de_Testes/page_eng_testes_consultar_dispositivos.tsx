...
export function ConsultarDispositivos() {
    ...
    useEffect(() => {
        const fetchDispositivos = async () => {
            try {
                // Dispositivos
                const responseDispositivos = await fetch('http://172.17.12.33:5000/api/dispositivos');
                if (responseDispositivos.ok) {
                    ...
                    // Notas Fiscais
                    const responseEntradaSaidaEquipamento = await fetch('http://172.17.12.33:5000/api/entradaSaidaEquipamento');
                    const responseNotasFiscais = await fetch('http://172.17.12.33:5000/api/notasFiscais');
