...
export function ConsultarDispositivos() {
    ...
    useEffect(() => {
        const fetchDispositivos = async () => {
            try {
                // Dispositivos
                const responseDispositivos = await fetch('http://172.21.96.1:5173/api/dispositivos');
                if (responseDispositivos.ok) {
                    ...
                    // Notas Fiscais
                    const responseEntradaSaidaEquipamento = await fetch('http://172.21.96.1:5173/api/entradaSaidaEquipamento');
                    const responseNotasFiscais = await fetch('http://172.21.96.1:5173/api/notasFiscais');
