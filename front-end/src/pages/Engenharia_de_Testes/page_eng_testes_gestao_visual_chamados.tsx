...
export function GestaoVisualChamados() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const responseCall = await fetch('http://172.17.12.33:5000/api/visualizarchamados');
                if (responseCall.ok) {
                ...
                const responseDailyIndex = await fetch('http://172.17.12.33:5000/api/indicadoresdiarios');
                ...
                const responseWeekIndex = await fetch('http://172.17.12.33:5000/api/indicadoressemanais');
                ...
                const responseMonthIndex = await fetch('http://172.17.12.33:5000/api/indicadoresmensais');
                ...
                const responseNotificacaoChamados = await fetch('http://172.17.12.33:5000/api/notificacaochamadosatrasados');
