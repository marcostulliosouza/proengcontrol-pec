...
export function GestaoVisualChamados() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const responseCall = await fetch('http://172.21.96.1:5173/api/visualizarchamados');
                if (responseCall.ok) {
                ...
                const responseDailyIndex = await fetch('http://172.21.96.1:5173/api/indicadoresdiarios');
                ...
                const responseWeekIndex = await fetch('http://172.21.96.1:5173/api/indicadoressemanais');
                ...
                const responseMonthIndex = await fetch('http://172.21.96.1:5173/api/indicadoresmensais');
                ...
                const responseNotificacaoChamados = await fetch('http://172.21.96.1:5173/api/notificacaochamadosatrasados');
