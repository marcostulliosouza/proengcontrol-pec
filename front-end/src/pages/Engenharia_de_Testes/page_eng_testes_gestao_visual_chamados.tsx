...
export function GestaoVisualChamados() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const responseCall = await fetch('http://backend:5000/api/visualizarchamados');
                if (responseCall.ok) {
                ...
                const responseDailyIndex = await fetch('http://backend:5000/api/indicadoresdiarios');
                ...
                const responseWeekIndex = await fetch('http://backend:5000/api/indicadoressemanais');
                ...
                const responseMonthIndex = await fetch('http://backend:5000/api/indicadoresmensais');
                ...
                const responseNotificacaoChamados = await fetch('http://backend:5000/api/notificacaochamadosatrasados');
