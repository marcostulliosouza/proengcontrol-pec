    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const responseAtendidos = await fetch(`http://backend:5000/api/chamadosatendidos?dataInicial=${encodeURIComponent(dataInicialString)}&dataFinal=${encodeURIComponent(dataFinalString)}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
