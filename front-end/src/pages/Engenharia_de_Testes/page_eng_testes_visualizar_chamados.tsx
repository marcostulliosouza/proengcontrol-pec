...
export function VisualizarChamados() {
    ...
    return (
        <>
            <div className="flex flex-col bg-cinza-200">
                <div className='p-4 inline-flex items-center'>
                    ...
                    <div className="flex items-center gap-2 text-pec font-semibold">
                        <img src={logo} alt="PEC" className="h-10" />
                        <div className="flex flex-col items-center">
                            <h1 className='text-xl'>PEC</h1>
                            <p className='text-sm'>ProEngControl</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-2 text-pec font-bold'>
