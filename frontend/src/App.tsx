...
import { GerenciamentoEstoque } from './pages/Engenharia_de_Testes/page_eng_testes_gerenciamento_insumos';
...
import { SolicitacaoPedidoInsumo } from './pages/Engenharia_de_Testes/page_eng_testes_pedidos_insumos'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/engenharia_testes/solicitar_insumo" element={<PrivateRoute redirectTo="/">
          <SolicitacaoPedidoInsumo />
        </PrivateRoute>} />
